...
def run(plot=True, training=False, n_episodes=1, n_steps=None, curr_path="."):
    ...
    results, uncert_metrics = experiment.run_evaluation(
    ...
    certified_results, cert_metrics = experiment.run_evaluation(
        n_episodes=n_episodes, n_steps=n_steps
    )
    ctrl.close()
    ...
    if plot is True:
        ...
        _, ax = plt.subplots()
        ax.plot(
            results["obs"][0][:, graph1_1],
            results["obs"][0][:, graph1_2],
            "r--",
            label="Uncertified",
        )
        ax.plot(
            certified_results["obs"][0][:, graph1_1],
            certified_results["obs"][0][:, graph1_2],
            ".-",
            label="Certified",
        )
        ax.plot(
            certified_results["obs"][0][corrections, graph1_1],
            certified_results["obs"][0][corrections, graph1_2],
            "r.",
            label="Modified",
        )
        ax.scatter(
            results["obs"][0][0, graph1_1],
            results["obs"][0][0, graph1_2],
            color="g",
            marker="o",
            s=100,
            label="Initial State",
        ...
        if (
            ...
            _, ax2 = plt.subplots()
            ax2.plot(
                np.linspace(0, 20, certified_results["obs"][0].shape[0]),
                safety_filter.env.X_GOAL[:, 0],
                "g--",
                label="Reference",
            )
            ax2.plot(
                np.linspace(0, 20, results["obs"][0].shape[0]),
                results["obs"][0][:, 0],
                "r--",
                label="Uncertified",
            )
            ax2.plot(
                np.linspace(0, 20, certified_results["obs"][0].shape[0]),
                certified_results["obs"][0][:, 0],
                ".-",
                label="Certified",
            )
            ax2.plot(
                np.linspace(0, 20, certified_results["obs"][0].shape[0])[corrections],
                certified_results["obs"][0][corrections, 0],
                "r.",
                label="Modified",
            )
            ...
            ax2.plot(
                certified_results["obs"][0][:, 1],
                certified_results["obs"][0][:, 3],
                ".-",
                label="Certified",
            )
            ax2.plot(
                certified_results["obs"][0][corrections, 1],
                certified_results["obs"][0][corrections, 3],
                "r.",
                label="Modified",
            )
        ...
        _, ax3 = plt.subplots()
        ax3.plot(
            results["obs"][0][:, graph3_1],
            results["obs"][0][:, graph3_2],
            "r--",
            label="Uncertified",
        )
        ax3.plot(
            certified_results["obs"][0][:, graph3_1],
            certified_results["obs"][0][:, graph3_2],
            ".-",
            label="Certified",
        )
        if (
        ...
        ax3.plot(
            certified_results["obs"][0][corrections, graph3_1],
            certified_results["obs"][0][corrections, graph3_2],
            "r.",
            label="Modified",
        )
        ax3.scatter(
            results["obs"][0][0, graph3_1],
            results["obs"][0][0, graph3_2],
            color="g",
            marker="o",
            s=100,
            label="Initial State",
        ...
        if config.task == Environment.CARTPOLE:
            ax_act.plot(
                certified_results["current_physical_action"][0][:],
                "b-",
            ...
            ax_act.plot(
                results["current_physical_action"][0][:],
                "g--",
                label="Uncertified Input",
            )
        else:
            ax_act.plot(
                certified_results["current_physical_action"][0][:, 0],
                "b-",
                label="Certified Input 1",
            )
            ax_act.plot(
                certified_results["current_physical_action"][0][:, 1],
                "b--",
            ...
            ax_act.plot(
                results["current_physical_action"][0][:, 0],
                "g-",
                label="Uncertified Input 1",
            )
            ax_act.plot(
                results["current_physical_action"][0][:, 1],
                "g--",
