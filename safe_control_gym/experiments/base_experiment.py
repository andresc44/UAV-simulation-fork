...
class BaseExperiment:
    ...
    def run_evaluation(
        ...
        **kwargs,
        ...
        trajs_data = self._execute_evaluations(
            log_freq=log_freq, n_episodes=n_episodes, n_steps=n_steps, **kwargs
        )
    ...
    def _execute_evaluations(
        self, n_episodes=None, n_steps=None, log_freq=None, seeds=None
    ):
    ...
    def _select_action(self, obs, info):
        ...
        if self.safety_filter is not None:
            ...
            certified_action, _ = self.safety_filter.certify_action(
