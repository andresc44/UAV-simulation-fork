...
def update(frame):
    ...
    colors = ['r', 'g', 'b']
    for i in range(3):
        Arrow3D(ax, positions[frame, 0], positions[frame, 1], positions[frame, 2],
    ...
    ax.text2D(0.05, 0.95, f'Frame: {frame}', transform=ax.transAxes, fontsize=10, verticalalignment='top')
# Create animation
