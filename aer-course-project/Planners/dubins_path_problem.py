...
class RRT_dubins_problem():
    ...
    def draw_graph(self):
        ...
        plt.grid(True)
        plt.arrow(self.goal.x, self.goal.y, 0.5 * math.cos(self.goal.yaw), 0.5 * math.sin(self.goal.yaw), head_width=0.2, head_length=0.2)
        plt.arrow(self.start.x, self.start.y, 0.5 * math.cos(self.start.yaw), 0.5 * math.sin(self.start.yaw), head_width=0.2, head_length=0.2)
...
def get_path(path_node_list):
    ...
    path = [[path_node_list[0].x, path_node_list[0].y, path_node_list[0].yaw]]
